if kTranslateMessage then
    ...
    kTranslateMessage["RANK_T5"] = "(C5):<Onos>"
    kTranslateMessage["RANK_T4"] = "(C4):<Fade>"
    kTranslateMessage["RANK_T3"] = "(C3):<Lerk>"
    kTranslateMessage["RANK_T2"] = "(C2):<Gorge>"
    kTranslateMessage["RANK_T1"] = "(C1):<Skulk>"
...
if kLocales then
    ...
    kLocales["RANK_T5"] = "(C5):<Onos>"
    kLocales["RANK_T4"] = "(C4):<Fade>"
    kLocales["RANK_T3"] = "(C3):<Lerk>"
    kLocales["RANK_T2"] = "(C2):<Gorge>"
    kLocales["RANK_T1"] = "(C1):<Skulk>"
