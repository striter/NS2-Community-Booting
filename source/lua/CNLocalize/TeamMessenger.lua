...
local locationStringGen = function(locationId, messageString) return string.format(Locale.ResolveString(messageString), CNResolveLocation( Shared.GetString(locationId))) end
