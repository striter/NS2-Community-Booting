...
function GUIExoEject:Initialize()
    ...
    self.text3:SetText(Locale.ResolveString(gBoomBoxDefine[EBoomBoxTrack.TWO].titleKey))
    ...
    self.text4:SetText(Locale.ResolveString(gBoomBoxDefine[EBoomBoxTrack.SONG].titleKey))
...
function GUIExoEject:Update(deltaTime)
    ...
    self.text5:SetText(player:GetBoomBoxAction())
