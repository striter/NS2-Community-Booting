...
Event.Hook("Console_kobe", function()
    SendRequest(kVoiceId.Kobe)
end)
Event.Hook("Console_meow", function()
    SendRequest(kVoiceId.Meow)
end)
Event.Hook("Console_hiss", function()
...
Event.Hook("Console_chicken", function()
    SendRequest(kVoiceId.chicken)
end)
