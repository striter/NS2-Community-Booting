...
ModLoader.SetupFileHook( "lua/Globals.lua", "lua/CNCommunityRank/CallingCards/Items/Globals.lua", "post" )
ModLoader.SetupFileHook( "lua/menu2/PlayerScreen/CallingCards/GUIMenuCallingCardData.lua", "lua/CNCommunityRank/CallingCards/Items/GUIMenuCallingCardData.lua", "replace")
