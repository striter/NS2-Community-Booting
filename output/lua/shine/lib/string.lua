...
do
    ...
    if Server then
        ...
        TimeFuncs = {
            function(Time)
                return Floor(Time % 60), "second", "seconds"
            end,
            function(Time)
                return Floor(Time / 60) % 60, "minute", "minutes"
            end,
            function(Time)
                return Floor(Time / 3600) % 24, "hour", "hours"
            end,
            function(Time)
                return Floor(Time / 86400) % 7, "day", "days"
            end,
            function(Time)
                return Floor(Time / 604800), "week", "weeks"
            end
        }
    else
        ...
        TimeFuncs = {
            function(Time)
                return Floor(Time % 60), "SECOND"
            end,
            function(Time)
                return Floor(Time / 60) % 60, "MINUTE"
            end,
            function(Time)
                return Floor(Time / 3600) % 24, "HOUR"
            end,
            function(Time)
                return Floor(Time / 86400) % 7, "DAY"
            end,
            function(Time)
                return Floor(Time / 604800), "WEEK"
            end
        }
    end
    ...
    function string.TimeToString(Time)
        if Time < 1 then
            return GetAsString(TimeFuncs[1](0))
        end
