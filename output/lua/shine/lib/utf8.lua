...
local function IdentityValid(Bytes)
    return Bytes
end
...
ValidityChecks[0xE0] = function(Bytes)
    return Bytes[2] >= 0xA0 and Bytes or nil
end
ValidityChecks[0xF0] = function(Bytes)
    return Bytes[2] >= 0x90 and Bytes or nil
end
ValidityChecks[0xF4] = function(Bytes)
    return Bytes[2] <= 0x8F and Bytes or nil
end
-- Check for UTF-16 surrogate halves (0xD800 - 0xDFFF).
ValidityChecks[0xED] = function(Bytes)
    return Bytes[2] <= 0x9F and Bytes or nil
end
