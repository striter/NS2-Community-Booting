...
do
    ...
    local function DeepEquals(Table1, Table2, Comparing)
        ...
        for Key, Value in pairs(Table1) do
            if not DeepEquals(Value, rawget(Table2, Key), Comparing) then
                return false
            end
        end
...
do
    ...
    local function IsComparable(A, B)
        ...
        if LeftType == RightType and ComparableTypes[LeftType] then
            return true
        end
