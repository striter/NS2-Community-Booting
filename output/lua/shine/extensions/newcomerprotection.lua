...
function Plugin:OnFirstThink()
    ...
    local damageTakenOverride = { OverrideWithoutWarning = true }
	Shine.Hook.SetupClassHook("Marine", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
	Shine.Hook.SetupClassHook("JetpackMarine", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
	Shine.Hook.SetupClassHook("Exo", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
	Shine.Hook.SetupClassHook("Lerk", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
	Shine.Hook.SetupClassHook("Skulk", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
	Shine.Hook.SetupClassHook("Gorge", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
	Shine.Hook.SetupClassHook("Fade", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
	Shine.Hook.SetupClassHook("Onos", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
    Shine.Hook.SetupClassHook("Prowler", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
    Shine.Hook.SetupClassHook("Vokex", "ModifyDamageTaken", "OnModifyDamageTaken", "PassivePost",damageTakenOverride)
