...
local locationStringGen = function(locationId, messageString) return string.format(Locale.ResolveString(messageString), Locale.ResolveLocation( Shared.GetString(locationId))) end
