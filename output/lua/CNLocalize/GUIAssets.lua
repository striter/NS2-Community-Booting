...
Fonts.kMicrogrammaDBolExt_Huge = PrecacheAsset("fonts/MicrogrammaDBolExt_huge.fnt")

-- For properly adjusting font scales, group them with their sizes
-- Not needed for the ones that are only one font
-- List font families at the start to be able to iterate over them numerical
...
Textures.kParasiteIndicator = PrecacheAsset("ui/parasite_hud.dds")
...
PrecacheAsset("models/marine/grenadelauncher/grenade_launcher_view_display.dds")
PrecacheAsset("models/marine/grenadelauncher/grenade_launcher_view_display1.dds")

PrecacheAsset("ui/flamethrowerdisplay.dds")
PrecacheAsset("ui/flamethrowerdisplay1.dds")
PrecacheAsset("ui/flamethrowerdisplay2.dds")

PrecacheAsset("ui/rifledisplay0.dds")
PrecacheAsset("ui/rifledisplay1.dds")
PrecacheAsset("ui/rifledisplay2.dds")
PrecacheAsset("ui/rifledisplay3.dds")
PrecacheAsset("ui/rifledisplay4.dds")
PrecacheAsset("ui/rifledisplay5.dds")

PrecacheAsset("ui/shotgundisplay0.dds")
PrecacheAsset("ui/shotgundisplay1.dds")
PrecacheAsset("ui/shotgundisplay2.dds")
PrecacheAsset("ui/shotgundisplay3.dds")

PrecacheAsset("ui/WelderSquares.dds")
PrecacheAsset("ui/weldersquares1.dds")

PrecacheAsset("ui/hmgdisplay0.dds")
